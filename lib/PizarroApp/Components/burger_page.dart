...
import '../Provider/pizza_provider.dart';
...
class BurgerPage extends StatelessWidget {
  ...
  List imag = [
    ...
    'https://freepngimg.com/thumb/burger/158972-burger-cheese-classic-free-clipart-hq.png',
    'https://www.pngall.com/wp-content/uploads/2016/05/Burger-Free-Download-PNG.png',
  ];
  List text=['Salmon','Apprepite','Cheesy'];
  @override
                  ...
                  child: Stack(clipBehavior: Clip.none,
                    children: [
                      ...
                      Positioned(
                          left: 139,
                          top: -2,
                          child: Icon(provider.selIcon==index?
                          Icons.check_circle :Icons.add_circle_outlined,
                            color:provider.selIcon==index?Colors.green:Color(0xFFefb331) ,
                          )),
                    ],
                  ),
                ),
